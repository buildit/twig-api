...
function createView (twigletName, view) {
  return authAgent.post(`/twiglets/${twigletName}/views`).send(view);
}

function updateView (twigletName, viewName, view) {
  return authAgent.put(`/twiglets/${twigletName}/views/${viewName}`).send(view);
}

function getView (twigletName, viewName) {
  return anonAgent.get(`/twiglets/${twigletName}/views/${viewName}`);
}

function getViews (twigletName) {
  return anonAgent.get(`/twiglets/${twigletName}/views`);
}

function deleteView (twigletName, viewName) {
  return authAgent.delete(`/twiglets/${twigletName}/views/${viewName}`);
}
